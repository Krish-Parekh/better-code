        ...
        testCases: [
            {
                ...
                output: "[0, 1]",
                bodyMdx: "**Input:** `nums = [2, 7, 11, 15]`, `target = 9`\n\n**Output:** `[0, 1]`\n\n**Explanation:** Because `nums[0] + nums[1] = 2 + 7 = 9`, we return `[0, 1]`.",
            },
            {
                stdin: "3 2 4\n6",
                stdout: "[1, 2]",
                input: "nums = [3, 2, 4]\ntarget = 6",
                output: "[1, 2]",
                bodyMdx: "**Input:** `nums = [3, 2, 4]`, `target = 6`\n\n**Output:** `[1, 2]`\n\n**Explanation:** Because `nums[1] + nums[2] = 2 + 4 = 6`, we return `[1, 2]`.",
            },
            {
                stdin: "3 3\n6",
                stdout: "[0, 1]",
            ...
            },
            {
                ...
                output: "[2, 4]",
                bodyMdx: "**Input:** `nums = [-1, -2, -3, -4, -5]`, `target = -8`\n\n**Output:** `[2, 4]`\n\n**Explanation:** Because `nums[2] + nums[4] = -3 + -5 = -8`, we return `[2, 4]`.",
            },
        ],
    },
    {
        problemTitle: "Maximum Subarray Sum",
        testCases: [
            {
                ...
                output: "6",
                bodyMdx: "**Input:** `nums = [-2, 1, -3, 4, -1, 2, 1, -5, 4]`\n\n**Output:** `6`\n\n**Explanation:** The subarray `[4, -1, 2, 1]` has the largest sum = `6`.",
            },
            {
                stdin: "1",
                stdout: "1",
...
export default async function seedTestCases() {
    try {
        ...
        // Process each problem's test cases
        for (const { problemTitle, testCases: cases } of testCaseData) {
                ...
                try {
                    ...
                    const existing = await db
                        ...
                        .where(
                            and(
                                ...
                                eq(testCases.input, testCase.input),
                                eq(testCases.output, testCase.output)
                            )
                        )
                        .limit(1);
                    ...
                    if (existing.length > 0 && existing[0]) {
                        ...
                        await db
                            ...
                            .where(eq(testCases.id, existing[0].id));
                    } else {
                    ...
                    console.error(
                        `Error seeding test case for problem "${problemTitle}":`,
                        error
                    );
                    throw error;
                }
        ...
        console.log(`Seeded ${seededCount} test cases`);
    } catch (error) {
